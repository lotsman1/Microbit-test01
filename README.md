...
> Открыть эту страницу в [https://lotsman1.github.io/microbit-test01/](https://lotsman1.github.io/microbit-test01/)
...
* найдите **https://github.com/lotsman1/microbit-test01** и импортируйте

## Править этот проект ![Значок статуса сборки](https://github.com/lotsman1/microbit-test01/workflows/MakeCode/badge.svg)

Редактировать этот репозиторий в MakeCode.

* открыть [https://makecode.microbit.org/](https://makecode.microbit.org/)
* нажмите на **Импорт**, затем **Импорт URL**
* вставьте **https://github.com/lotsman1/microbit-test01** и нажмите Импорт
...
![Отрисовка в виде блоков](https://github.com/lotsman1/microbit-test01/raw/master/.github/makecode/blocks.png)
